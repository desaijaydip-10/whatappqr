package com.keyboard.qrwhatapps.Adapters;
...
import com.keyboard.qrwhatapps.Activity.ImageViewerActivity;
...
//    public ArrayList<ModelStatus> arrayList;
    ...
    public void onBindViewHolder(MyViewHolder myViewHolder, int i) {
        ...
        Glide.with(this.acontext).load(arrayList.get(i).getFull_path()).into(myViewHolder.imageView);
    }
    ...
    public void shareVia( String str2) {
...
//                    }
            ...
            imageButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ModelStatus modelStatus = (ModelStatus) WhatsAppPictureAdaptor.this.arrayList.get(MyViewHolder.this.getAdapterPosition());
//                    if (modelStatus.getFull_path().endsWith(".jpg")) {
//                        WhatsAppPictureAdaptor.this.shareVia( modelStatus.getFull_path());
//                    }else  if(modelStatus.getFull_path().endsWith(".png")){
//                        WhatsAppPictureAdaptor.this.shareVia(modelStatus.getFull_path());
//                    }
//                    else if (modelStatus.getFull_path().endsWith(".mp4")) {
//                        WhatsAppPictureAdaptor.this.shareVia( modelStatus.getFull_path());
//                    }
            ...
            imageButton2.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    String str;
                    ModelStatus modelStatus = arrayList.get(MyViewHolder.this.getAdapterPosition());

                    String strurl= modelStatus.getFull_path().trim();

                    setdownloadimg(strurl);
                    if (modelStatus.getType() == 0) {
                        str = Config.WhatsAppSaveStatus;
                    } else {
                        str = modelStatus.getType() == 1 ? Config.WhatsAppBusinessSaveStatus : "";
        ...
        private void setdownloadimg(String strurl) {
